  ...
  static getSelectRects(startTextNode, endTextNode) {
    ...
    if (lineMergedRects.length > 0) {
      ...
      startLineHeight =
        ...
        Number(window.getComputedStyle(startTextNode.node.parentElement).height.replace('px', ''))
    ...
    if (lineMergedRects.length > 0) {
      ...
      endLineHight =
        Number(window.getComputedStyle(endTextNode.node.parentElement).lineHeight.replace('px', '')) ||
        Number(window.getComputedStyle(startTextNode.node.parentElement).height.replace('px', ''))
